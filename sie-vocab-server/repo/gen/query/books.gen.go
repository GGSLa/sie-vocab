...
func newBook(db *gorm.DB, opts ...gen.DOOption) book {
	...
	_book.UserID = field.NewInt32(tableName, "user_id")
	...
	_book.PdfPath = field.NewString(tableName, "pdf_path")
	_book.OcrLang = field.NewString(tableName, "ocr_lang")
	_book.PageCount = field.NewInt32(tableName, "page_count")
...
type book struct {
	...
	PdfPath     field.String
	OcrLang     field.String
...
func (b *book) updateTableName(table string) *book {
	...
	b.PdfPath = field.NewString(table, "pdf_path")
	b.OcrLang = field.NewString(table, "ocr_lang")
	b.PageCount = field.NewInt32(table, "page_count")
...
func (b *book) fillFieldMap() {
	...
	b.fieldMap["pdf_path"] = b.PdfPath
	b.fieldMap["ocr_lang"] = b.OcrLang
	b.fieldMap["page_count"] = b.PageCount
