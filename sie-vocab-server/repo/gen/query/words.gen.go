...
func newWord(db *gorm.DB, opts ...gen.DOOption) word {
	...
	_word.ID = field.NewInt32(tableName, "id")
	_word.UserID = field.NewInt32(tableName, "user_id")
	_word.Word = field.NewString(tableName, "word")
	_word.BaseWord = field.NewString(tableName, "base_word")
	_word.Type = field.NewString(tableName, "type")
	_word.Pos = field.NewString(tableName, "pos")
	_word.Derivation = field.NewString(tableName, "derivation")
	_word.CreatedAt = field.NewTime(tableName, "created_at")
	_word.UpdatedAt = field.NewTime(tableName, "updated_at")
	_word.ReviewCount = field.NewInt32(tableName, "review_count")
	_word.NextReviewDate = field.NewString(tableName, "next_review_date")
...
type word struct {
	...
	UserID         field.Int32
	Word           field.String
	BaseWord       field.String
	Type           field.String
	Pos            field.String
	Derivation     field.String
	CreatedAt      field.Time
	UpdatedAt      field.Time
	ReviewCount    field.Int32
	NextReviewDate field.String
...
func (w *word) updateTableName(table string) *word {
	...
	w.BaseWord = field.NewString(table, "base_word")
	w.Type = field.NewString(table, "type")
	w.Pos = field.NewString(table, "pos")
	w.Derivation = field.NewString(table, "derivation")
	w.CreatedAt = field.NewTime(table, "created_at")
	w.UpdatedAt = field.NewTime(table, "updated_at")
	w.ReviewCount = field.NewInt32(table, "review_count")
	w.NextReviewDate = field.NewString(table, "next_review_date")
...
func (w *word) fillFieldMap() {
	...
	w.fieldMap["base_word"] = w.BaseWord
	w.fieldMap["type"] = w.Type
	w.fieldMap["pos"] = w.Pos
	w.fieldMap["derivation"] = w.Derivation
	w.fieldMap["created_at"] = w.CreatedAt
	w.fieldMap["updated_at"] = w.UpdatedAt
	w.fieldMap["review_count"] = w.ReviewCount
	w.fieldMap["next_review_date"] = w.NextReviewDate
}
